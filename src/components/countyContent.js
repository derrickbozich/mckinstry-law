    ...
    <div className="single-page single-page-content cherry-creek">
      ...
      <div className="body">
        <p>
          ...
          Due to the serious nature of the potential consequences of this
          ...
          procedures and filings in these matters. If you choose to go to trial,
          you need a lawyer who possesses the confidence, experience, and
          technical proficiency necessary to vigorously and effectively defend
          your rights and interests in front of a jury.
        </p>
        <p>
          If convicted of a DUI, the consequences may include jail time,
          substantial fines, a suspended driver’s license, as well as a damaged
          personal and professional reputation. With so much at stake, a highly
          qualified attorney is essential.
        </p>
        <p>
          ...
          outcome in your case. If you are facing DUI-Drug charges, your lawyer
          must understand the science and the practical realities of roadside
          drug recognition, as well as the complexities of blood testing, and
          its often dubious and misleading results. Your lawyer must be able to
          locate and isolate the flaws in the state’s case, and to make those
          weaknesses clear to the fact finders.
        </p>
        <p>
          As a Deputy DA and criminal defense attorney, Mr. McKinstry has
          handled thousands of DUI, DUR (Driving Under Revocation), and related
          vehicular offenses. He has litigated dozens of these cases in front of
          Colorado juries.
        </p>
      </div>
      ...
      <div className="body">
        ...
        <p>
          ...
          government to its burden of proof and do everything possible to expose
          and exploit the weaknesses in the state’s case.
        </p>
      </div>
      <h3 className="header">Felony Charges</h3>

      <div className="body">
        <p>
          If you are facing felony charges in the state of Colorado, then you
          ...
          entitled to, including potentially exculpatory evidence. Your lawyer
        ...
        <p>
          ...
          go to trial. Mr. McKinstry’s experience as a defense attorney and
          former prosecutor gives him an edge in his negotiations with the
          prosecution. His many years of experience in the Courts increases the
          likelihood of reasonable negotiated resolutions of cases with the
          least possible punishment to his clients.
        </p>
        <p>
          As a defense attorney in state Courts, Mr. McKinstry’s priority is to
          ensure that your constitutional rights are protected and the burdens
          you face are minimized. The first line of defense deployed by a
          criminal defense lawyer in many criminal cases is the filing of
          motions to suppress evidence. If the Police or prosecuting attorney
          violated your rights in any way while collecting evidence, Mr.
          McKinstry will fight to suppress that evidence and, when successful,
          this can lead to dismissal of the criminal charges. The government
          must follow the rules, no matter what the charge. This is the
          foundation of ordered liberty.
        </p>
        <p>
          Mr. McKinstry has litigated dozens of state criminal cases in front of
          Colorado juries, including attempted murder, felony assault, drug
          possession/distribution, conspiracy, identity theft, and burglary.
        </p>
      </div>

      <h4 className="header">Burglary</h4>
      ...
      <h4 className="header">Identity Theft</h4>

      <div className="body">
        <p>
          Identity Theft charges are also on the rise, and like Burglary
          charges, such offenses can result in loss of liberty, loss of present
          and future employment, and reputation. We know how to defend against
          Identity Theft charges, and will fight to clear you name and preserve
          your liberty.
        </p>
      </div>
      <h4 className="header">Assault</h4>

      <div className="body">
        <p>
          Felony Assault charges, including Domestic Violence Assault, are often
          brought against citizens who are merely defending themselves. The
          McKinstry Law Firm has litigated Assault cases in front of Colorado
          juries, and won acquittals based on the theory of self-defense.
        </p>
      </div>
      <h4 className="header">Drug Possession</h4>

      <div className="body">
        <p>
          Felony Drug Possession, Distribution, Manufacture and Sale charges are
          serious, and can affect all aspects of your life, including potential
          loss of liberty, loss of present and future employment, and damage to
          reputation. The McKinstry Law Firm has achieved excellent results in
          defending cases involving Drug Possession, Distribution, Manufacture,
          and Sale.
        </p>
      </div>

      <h3 className="header">Juvenile Offenses</h3>
      ...
      <div className="body">
        ...
        <p>
          ...
          innocence and due process as adults, and the government is held to the
          same high standards of proof in prosecuting juvenile defendants.
        </p>
        <p>
          The scientific, medical, and behavioral health communities understand
          that the human brain is still developing well into a young person’s
          twenties, and all adolescents are susceptible to impulsive and
          reckless behavior. It’s crucial that a child’s future not be derailed
          by a lapse in judgment, even a serious one, and a criminal attorney
          who has the necessary experience and proficiency can, in many cases,
          work with the prosecution to achieve a satisfactory disposition. But
          if the case goes to trial, you’ll want a lawyer on your side who has
          litigated juvenile delinquency cases. Mr. McKinstry has litigated
          juvenile felonies and misdemeanors in state court, and knows how to
          expose the weaknesses that exist in every case, offering your best
          chance at an acquittal.
        </p>
        <p>
          Mr. McKinstry has litigated dozens of state criminal cases in front of
          Colorado juries, including attempted murder, felony assault, drug
      ...
      <h5 className="header">Municipal Charges</h5>
      ...
      <div className="body">
        ...
        <p>
          ...
          municipal ordinance, you must defend your liberty and your reputation
          as vigorously as you would in state court, and you will benefit from
          the assistance of a criminal lawyer who knows the system and can
          identify and exploit the weaknesses in the municipality’s case.
          Whether you’re charged with a fire or building code violation, or
          something as serious as assault, you should not go it alone.
        </p>
        <p>
      ...
      <h5 className="header">Misdemeanor Charges</h5>
      ...
      <div className="body">
        ...
        <p>
          ...
          and rights at trial, the firm understands that some cases do not have
          to go to trial. Mr. McKinstry’s experience as a defense attorney and
          former prosecutor gives him an advantage in his negotiations with the
          prosecution. His years of experience in the Courts makes much more
          likely reasonable negotiated resolutions of cases, and the least
          possible punishment to his clients.
        </p>
        <p>
          Mr. McKinstry’s priority is to ensure the protection of your
          constitutional rights and the burdens you face are minimized. Often
          defense lawyers will file motions to suppress evidence. The Police or
          prosecuting attorney may have violated your rights in some way while
          collecting evidence and Mr. McKinstry will fight hard to suppress that
          evidence. If successful, this can lead to dismissal of criminal
          charges. A foundation of ordered liberty is that the government must
          follow the rules, no matter the charge.
        </p>
        <p>
          Misdemeanor Assault charges are also brought against citizens who are
          merely defending themselves. Again, the McKinstry Law Firm has
          litigated Assault cases in front of Colorado juries, and won
          acquittals based on the theory of self-defense.
        </p>
        <p>
          Mr. McKinstry has litigated dozens of state criminal misdemeanor cases
          in front of Colorado juries, including simple assault, theft,
          harassment, drug possession, criminal mischief, domestic violence, and
          child abuse.
        </p>
      </div>
