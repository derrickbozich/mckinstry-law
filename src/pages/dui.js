  ...
  <Layout>
    ...
    <div className="single-page narrow-container dui">
      ...
      <div className="small-para">
        ...
        not only knows Colorado DUI law, but who also knows the court system,
        the science of DUI testing, and the time-sensitive nature of the
        procedures and filings in DUI matters. If you choose to go to trial, you
        need an attorney who possesses the confidence, experience, and technical
        proficiency necessary to vigorously and effectively defend your rights
        and interests in front of a jury.   If convicted of a DUI, the
        consequences may include jail time, substantial fines, a suspended
        ...
        proper defense in a timely manner is essential to a satisfactory outcome
        in your case.
        <br />
        ...
        misleading results. Your attorney must be able to locate and isolate the
        flaws in the state’s case, and to make those weaknesses clear to the
        factfinders.
        <br />
        Mr. McKinstry has handled thousands of DUI cases, DUR (driving Under
        Revocation), and related vehicular offenses. He has litigated dozens of
        DUI cases in front of Colorado juries.
      </div>
    </div>
  </Layout>
)
